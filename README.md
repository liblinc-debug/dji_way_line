...
商业版创建流程支持引导式选择航线类型、飞行器型号和航线名称，确认后进入对应航线编辑器。
...
新增云台视角预览和虚拟飞行能力，可在航点编辑过程中实时查看相机视场、云台俯仰角、变焦倍率和飞行姿态，辅助判断拍摄覆盖范围与航点动作是否符合任务预期。
...
- **商业版航线类型**：覆盖航点航线、巡逻航线、面状航线、带状航线、斜面航线、几何体航线等作业场景
